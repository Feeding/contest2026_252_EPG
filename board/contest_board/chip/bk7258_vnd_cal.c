...
/* AVDK's BK7258 polar-mode BLE table.  Polar modulation uses a different
 * gain index space from the IQ table above; the controller selects this
 * symbol when bt_feature.rf_mode is RF_MODE_POLAR.
 */
